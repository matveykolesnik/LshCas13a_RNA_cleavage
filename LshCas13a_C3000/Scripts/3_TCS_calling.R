...
N5E_counts_file <- "Results/Tables/Merged_ends_counts/N5E_TAP_untreated_T_vs_NT.tsv.gz"
...
samples <- factor(rep(c("targeting", "nontargeting"), each=3))
