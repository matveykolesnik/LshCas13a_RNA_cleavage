...
setwd("~/data/LshCas13a_RNA_cleavage/LshCas13a_C3000/WT_TSS_calling_old_assembly/")
dir.create("Results/Tables/TSS_detection_tables")

N5E_counts_file <- "Results/Tables/Merged_ends_counts/N5E_NT_TAP_treated_vs_TAP_untreated.tsv.gz"
...
write.table(result_table, file = "Results/Tables/TSS_detection_tables/NT_cells_TSS_predictions.tsv", sep = "\t", row.names = F, quote = F)
