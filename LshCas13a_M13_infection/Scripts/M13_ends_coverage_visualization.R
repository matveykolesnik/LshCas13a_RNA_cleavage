...
ReadsCoverageTable <- "Results/Tables/Merged_ends_counts/N5E_T_vs_NT.tsv.gz"
...
svg(filename = "Results/Pictures/M13_N5E_coverage_log_transformed.svg", width = 15, height = 7)
