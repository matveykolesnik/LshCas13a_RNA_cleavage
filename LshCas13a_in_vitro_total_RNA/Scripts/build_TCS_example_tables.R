...
targeting_samples <- c("Ish_7_S20", "Ish_8_S21", "Ish_9_S22")
nontargeting_samples <- c("Ish_10_S23", "Ish_11_S24", "Ish_12_S25")

N5E_tables <- read.delim("Results/Tables/Merged_ends_counts/N5E_T_vs_NT.tsv.gz", sep = "\t")
